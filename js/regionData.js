/* =========================================================
   中国行政区划数据 — 省 → 市 → 区/县(用于地点级联选择)
   数据结构: REGIONS = [{ name, cities:[{ name, districts:[String] }] }]
   说明: 涵盖 34 个省级单位 + 全部地级行政区 + 主要市辖区/县。
   完整数据集约 3000+ 区/县, 本文件收录常用市辖区/县(覆盖直辖市、
   省会、副省级及主要地级市), 其余区/县可在下方追加或通过其它数据源补全。
   ========================================================= */
window.REGIONS = [
  { name: '北京市', cities: [
  ...
  { name: '重庆市', cities: [
    { name: '重庆市', districts: ['渝中区','江北区','南岸区','沙坪坝区','九龙坡区','大渡口区','渝北区','巴南区','北碚区','万州区','涪陵区','黔江区','长寿区','江津区','合川区','永川区','南川区','綦江区','大足区','璧山区','铜梁区','潼南区','荣昌区','开州区','梁平区','武隆区','城口县','丰都县','垫江县','忠县','云阳县','奉节县','巫山县','巫溪县','石柱土家族自治县','秀山土家族苗族自治县','酉阳土家族苗族自治县','彭水苗族土家族自治县'] }
  ]},
  { name: '河北省', cities: [
    { name: '石家庄市', districts: ['长安区','桥西区','新华区','井陉矿区','裕华区','藁城区','鹿泉区','栾城区','井陉县','正定县','行唐县','灵寿县','高邑县','深泽县','赞皇县','无极县','平山县','元氏县','赵县','晋州市','新乐市','辛集市'] },
    { name: '唐山市', districts: ['路北区','路南区','古冶区','开平区','丰南区','丰润区','曹妃甸区','滦县','滦南县','乐亭县','迁西县','玉田县','遵化市','迁安市'] },
    ...
    { name: '邢台市', districts: ['桥东区','桥西区','南宫市','沙河市','邢台县','临城县','内丘县','柏乡县','隆尧县','任县','南和县','宁晋县','巨鹿县','新河县','广宗县','平乡县','威县','清河县','临西县'] },
    { name: '保定市', districts: ['竞秀区','莲池区','满城区','清苑区','徐水区','涿州市','定州市','安国市','高碑店市','涞水县','阜平县','定兴县','唐县','高阳县','容城县','涞源县','望都县','安新县','易县','曲阳县','蠡县','顺平县','博野县','雄县'] },
    { name: '张家口市', districts: ['桥东区','桥西区','宣化区','下花园区','万全区','崇礼区','张北县','康保县','沽源县','尚义县','蔚县','阳原县','怀安县','怀来县','涿鹿县','赤城县'] },
    { name: '承德市', districts: ['双桥区','双滦区','鹰手营子矿区','承德县','兴隆县','滦平县','隆化县','丰宁满族自治县','宽城满族自治县','围场满族蒙古族自治县','平泉市'] },
  ...
  { name: '山西省', cities: [
    ...
    { name: '长治市', districts: ['城区','郊区','潞州区','上党区','襄垣县','屯留区','平顺县','黎城县','壶关县','长子县','武乡县','沁县','沁源县','潞城市'] },
    { name: '晋城市', districts: ['城区','沁水县','阳城县','陵川县','泽州县','高平市'] },
    { name: '朔州市', districts: ['朔城区','平鲁区','山阴县','应县','右玉县','怀仁市'] },
  ...
  { name: '内蒙古自治区', cities: [
    ...
    { name: '包头市', districts: ['昆都仑区','青山区','东河区','石拐区','白云鄂博矿区','九原区','土默特右旗','固阳县','达尔罕茂明安联合旗'] },
  ...
  { name: '辽宁省', cities: [
    { name: '沈阳市', districts: ['和平区','沈河区','大东区','皇姑区','铁西区','浑南区','于洪区','沈北新区','苏家屯区','辽中区','康平县','法库县','新民市'] },
  ...
  { name: '吉林省', cities: [
    ...
    { name: '白山市', districts: ['浑江区','江源区','抚松县','靖宇县','长白朝鲜族自治县','临江市'] },
    { name: '松原市', districts: ['宁江区','前郭尔罗斯蒙古族自治县','长岭县','乾安县','扶余市'] },
  ...
  { name: '黑龙江省', cities: [
    ...
    { name: '鹤岗市', districts: ['向阳区','工农区','南山区','兴安区','东山区','萝北县','绥滨县'] },
  ...
  { name: '江苏省', cities: [
    ...
    { name: '南通市', districts: ['崇川区','港闸区','通州区','海安县','如东县','启东市','如皋市','海门市','海安市'] },
    { name: '连云港市', districts: ['连云区','海州区','赣榆区','东海县','灌云县','灌南县'] },
    { name: '淮安市', districts: ['淮安区','淮阴区','清江浦区','洪泽区','涟水县','盱眙县','金湖县'] },
    { name: '盐城市', districts: ['亭湖区','盐都区','大丰区','响水县','滨海县','阜宁县','射阳县','建湖县','东台市'] },
  ...
  { name: '浙江省', cities: [
    { name: '杭州市', districts: ['上城区','拱墅区','西湖区','滨江区','萧山区','余杭区','富阳区','临安区','桐庐县','淳安县','建德市'] },
    { name: '宁波市', districts: ['海曙区','江北区','北仑区','镇海区','鄞州区','象山县','宁海县','余姚市','慈溪市','奉化区'] },
    ...
    { name: '台州市', districts: ['椒江区','黄岩区','路桥区','玉环市','三门县','天台县','仙居县','温岭市','临海市'] },
  ...
  { name: '安徽省', cities: [
    ...
    { name: '宣城市', districts: ['宣州区','郎溪县','广德市','宁国市','绩溪县','旌德县','泾县'] }
  ]},
  { name: '福建省', cities: [
    { name: '福州市', districts: ['鼓楼区','台江区','仓山区','马尾区','晋安区','长乐区','闽侯县','连江县','罗源县','闽清县','永泰县','福清市','平潭县'] },
    ...
    { name: '泉州市', districts: ['鲤城区','丰泽区','洛江区','泉港区','惠安县','安溪县','永春县','德化县','南安市','晋江市','石狮市','金门县'] },
    { name: '漳州市', districts: ['芗城区','龙文区','云霄县','漳浦县','诏安县','长泰区','东山县','南靖县','平和县','华安县','龙海市'] },
  ...
  { name: '江西省', cities: [
    ...
    { name: '上饶市', districts: ['信州区','广丰区','上饶县','玉山县','铅山县','横峰县','弋阳县','余干县','鄱阳县','万年县','婺源县','德兴市'] }
  ]},
  { name: '山东省', cities: [
    ...
    { name: '烟台市', districts: ['芝罘区','福山区','牟平区','莱山区','蓬莱区','龙口市','莱阳市','莱州市','招远市','栖霞市','海阳市','长岛县'] },
    ...
    { name: '聊城市', districts: ['东昌府区','茌平区','阳谷县','莘县','东阿县','冠县','高唐县','临清市'] },
  ...
  { name: '河南省', cities: [
    ...
    { name: '开封市', districts: ['龙亭区','鼓楼区','禹王台区','顺河回族区','祥符区','杞县','通许县','尉氏县','兰考县'] },
    { name: '洛阳市', districts: ['老城区','西工区','瀍河回族区','涧西区','吉利区','洛龙区','孟津区','新安县','栾川县','嵩县','汝阳县','宜阳县','洛宁县','伊川县','偃师市'] },
    ...
    { name: '周口市', districts: ['川汇区','扶沟县','西华县','商水县','沈丘县','郸城县','淮阳区','太康县','鹿邑县','项城市'] },
  ...
  { name: '湖北省', cities: [
    ...
    { name: '十堰市', districts: ['茅箭区','张湾区','郧阳区','郧西县','竹山县','竹溪县','房县','丹江口市'] },
    ...
    { name: '仙桃市', districts: ['仙桃市'] },
    { name: '潜江市', districts: ['潜江市'] },
    { name: '天门市', districts: ['天门市'] },
    { name: '神农架林区', districts: ['神农架林区'] }
  ]},
  { name: '湖南省', cities: [
    ...
    { name: '邵阳市', districts: ['双清区','大祥区','北塔区','邵东市','新邵县','邵阳县','隆回县','洞口县','绥宁县','新宁县','城步苗族自治县','武冈市'] },
  ...
  { name: '广东省', cities: [
    ...
    { name: '江门市', districts: ['蓬江区','江海区','新会区','台山市','开平市','恩平市','鹤山市'] },
    ...
    { name: '清远市', districts: ['清城区','清新区','佛冈县','阳山县','连山壮族瑶族自治县','连南瑶族自治县','英德市','连州市'] },
  ...
  { name: '广西壮族自治区', cities: [
    ...
    { name: '桂林市', districts: ['秀峰区','叠彩区','象山区','七星区','雁山区','临桂区','阳朔县','灵川县','全州县','兴安县','永福县','灌阳县','资源县','平乐县','荔浦市','龙胜各族自治县','恭城瑶族自治县'] },
    ...
    { name: '百色市', districts: ['右江区','田阳区','田东县','平果市','德保县','靖西市','那坡县','凌云县','乐业县','田林县','西林县','隆林各族自治县'] },
  ...
  { name: '海南省', cities: [
    ...
    { name: '三亚市', districts: ['吉阳区','天涯区','崖州区','海棠区'] },
    { name: '三沙市', districts: ['西沙群岛','南沙群岛','中沙群岛的岛礁及其海域'] },
    { name: '儋州市', districts: ['儋州市'] },
    { name: '五指山市', districts: ['五指山市'] },
    { name: '琼海市', districts: ['琼海市'] },
    { name: '文昌市', districts: ['文昌市'] },
    { name: '万宁市', districts: ['万宁市'] },
    { name: '东方市', districts: ['东方市'] }
  ]},
  { name: '四川省', cities: [
    ...
    { name: '绵阳市', districts: ['涪城区','游仙区','安州区','江油市','三台县','盐亭县','梓潼县','平武县','北川羌族自治县'] },
    ...
    { name: '广安市', districts: ['广安区','前锋区','岳池县','武胜县','邻水县','华蓥市'] },
    ...
    { name: '阿坝藏族羌族自治州', districts: ['马尔康市','汶川县','理县','茂县','松潘县','九寨沟县','金川县','小金县','黑水县','壤塘县','阿坝县','若尔盖县','红原县'] },
    { name: '甘孜藏族自治州', districts: ['康定市','泸定县','丹巴县','九龙县','雅江县','道孚县','炉霍县','甘孜县','新龙县','德格县','白玉县','石渠县','色达县','理塘县','巴塘县','乡城县','稻城县','得荣县'] },
    { name: '凉山彝族自治州', districts: ['西昌市','盐源县','德昌县','会理市','会东县','宁南县','普格县','布拖县','金阳县','昭觉县','喜德县','冕宁县','越西县','甘洛县','美姑县','雷波县','木里藏族自治县'] }
  ]},
  { name: '贵州省', cities: [
  ...
  { name: '云南省', cities: [
    ...
    { name: '玉溪市', districts: ['红塔区','江川区','通海县','华宁县','易门县','峨山彝族自治县','新平彝族傣族自治县','元江哈尼族彝族傣族自治县','澄江市'] },
    ...
    { name: '楚雄彝族自治州', districts: ['楚雄市','禄丰市','双柏县','牟定县','南华县','姚安县','大姚县','永仁县','元谋县','武定县'] },
    { name: '红河哈尼族彝族自治州', districts: ['蒙自市','个旧市','开远市','弥勒市','建水县','石屏县','泸西县','元阳县','红河县','金平苗族瑶族傣族自治县','绿春县','河口瑶族自治县'] },
  ...
  { name: '陕西省', cities: [
    ...
    { name: '延安市', districts: ['宝塔区','安塞区','延长县','延川县','志丹县','吴起县','甘泉县','富县','洛川县','宜川县','黄龙县','黄陵县','子长市'] },
  ...
  { name: '青海省', cities: [
    ...
    { name: '海西蒙古族藏族自治州', districts: ['格尔木市','德令哈市','茫崖市','乌兰县','都兰县','天峻县','大柴旦行政委员会'] }
  ]},
  { name: '宁夏回族自治区', cities: [
  ...
  { name: '新疆维吾尔自治区', cities: [
    ...
    { name: '阿克苏地区', districts: ['阿克苏市','库车市','温宿县','沙雅县','新和县','拜城县','乌什县','阿瓦提县','柯坪县'] },
    { name: '克孜勒苏柯尔克孜自治州', districts: ['阿图什市','阿克陶县','阿合奇县','乌恰县'] },
    { name: '喀什地区', districts: ['喀什市','疏附县','疏勒县','英吉沙县','泽普县','莎车县','叶城县','麦盖提县','岳普湖县','伽师县','巴楚县','塔什库尔干干塔吉克自治县'] },
  ...
  { name: '台湾省', cities: [
    ...
    { name: '高雄市', districts: ['新兴区','前金区','苓雅区','盐埕区','鼓山区','旗津区','前镇区','三民区','左营区','楠梓区','小港区','仁武区','大社区','冈山区','路竹区','阿莲区','田寮区','燕巢区','桥头区','梓官区','弥陀区','永安区','湖内区','凤山区','大寮区','林园区','鸟松区','大树区','旗山区','美浓区','六龟区','内门区','杉林区','甲仙区','桃源区','那玛夏区','茂林区','茄萣区'] },
    { name: '台中市', districts: ['中区','东区','南区','西区','北区','北屯区','西屯区','南屯区','太平区','大里区','雾峰区','乌日区','丰原区','后里区','石冈区','东势区','和平区','新社区','潭子区','大雅区','神冈区','大肚区','沙鹿区','龙井区','梧栖区','清水区','大甲区','外埔区','大安区'] },
    { name: '台南市', districts: ['中西区','东区','南区','北区','安平区','安南区','永康区','归仁区','新化区','左镇区','玉井区','楠西区','南化区','仁德区','关庙区','龙崎区','官田区','麻豆区','佳里区','西港区','七股区','将军区','学甲区','北门区','新营区','后壁区','白河区','东山区','六甲区','下营区','柳营区','盐水区','善化区','大内区','山上区','新市区','安定区'] },
    { name: '基隆市', districts: ['中正区','七堵区','暖暖区','仁爱区','中山区','安乐区','信义区'] },
    { name: '新竹市', districts: ['东区','北区','香山区'] },
    { name: '嘉义市', districts: ['东区','西区'] },
    { name: '新北市', districts: ['板桥区','三重区','中和区','永和区','新庄区','新店区','土城区','芦洲区','汐止区','树林区','莺歌区','三峡区','淡水区','万里区','金山区','深坑区','石碇区','坪林区','三芝区','石门区','八里区','平溪区','双溪区','贡寮区','瑞芳区','泰山区','林口区'] },
    { name: '桃园市', districts: ['桃园区','中坜区','平镇区','八德区','杨梅区','芦竹区','大溪区','龙潭区','龟山区','大园区','观音区','新屋区','复兴区'] }
  ] },
  { name: '香港特别行政区', cities: [
    { name: '香港特别行政区', districts: ['中西区','湾仔区','东区','南区','油尖旺区','深水埗区','九龙城区','黄大仙区','观塘区','葵青区','荃湾区','屯门区','元朗区','北区','大埔区','沙田区','西贡区','离岛区'] }
  ]},
  { name: '澳门特别行政区', cities: [
    { name: '澳门特别行政区', districts: ['花地玛堂区','花王堂区','望德堂区','大堂区','风顺堂区','嘉模堂区','路氹填海区','圣方济各堂区'] }
  ]}
];